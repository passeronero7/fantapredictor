...
| Fantasy prices, roles, votes, and probable line-ups | Fantacalcio provider exports | No reliable public bulk source | Manual/provider-authorised import only. This is the canonical source for fantasy roles and votes. |
